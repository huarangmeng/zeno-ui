use zeno_core::{AppConfig, Backend, Platform, WindowConfig, ZenoError};

use crate::session::ResolvedSession;
use crate::shell::NativeSurfaceHostRequirement;
...
use super::render_session::{BoxedMobileRenderSession, create_mobile_render_session};
use super::session_plan::{MobileSessionPlan, create_mobile_surface, descriptor_for};
...
impl MobileShell {
    ...
    pub fn create_mobile_surface(
        ...
        self.create_mobile_surface_for_backend(
            config,
            viewport,
            Backend::Skia,
            match self.platform {
                MobilePlatform::Android => NativeSurfaceHostRequirement::AndroidNativeWindow,
                MobilePlatform::Ios => NativeSurfaceHostRequirement::IosViewOrMetalLayer,
            },
        )
    }

    #[must_use]
    pub fn create_mobile_surface_for_backend(
        &self,
        config: &WindowConfig,
        viewport: Option<MobileViewport>,
